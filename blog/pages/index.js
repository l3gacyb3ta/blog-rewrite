      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          <h1 className={styles.title}>
            <Hand></Hand>&nbsp;&nbsp;Hi, I'm <Sparkles>Raleigh</Sparkles>, a developer in highschool from the south.
          </h1>
          
          <div className={styles.description}>
            Hello! I’m <Sparkles>Raleigh</Sparkles> (he/they), I am a developer in high school. <br />
